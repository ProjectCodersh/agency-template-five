            ...
            <div className="col-lg-6">
              <div className="about-content">
                ...
                <p className="mt-3 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                  We are not just another agency - we are your digital growth partners. With years
                  of industry experience and a passion for innovation, our team is dedicated to
