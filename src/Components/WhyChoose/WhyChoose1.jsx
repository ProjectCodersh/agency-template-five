...
const WhyChoose1 = () => {
  const chooseContent = {
    ...
    title: 'Let’s team up to create something exceptional',
    content:
      'Get the ultimate team and learn how to grow your audience and build an online business.',
    img: '/assets/img/team/01.png',
    list1: 'Experienced Team',
    list2: 'Strict NDA Policy',
    list3: '100% Success Ratio',
    list4: 'Affordable Price',
    list5: 'Dedicated Team',
