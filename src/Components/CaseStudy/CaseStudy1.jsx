                    ...
                    <ul>
                      <li>
                        <Link to="/project/project-details">
                          Real-time Analytics <i className="bi bi-arrow-up-right"></i>
                        </Link>
                      </li>
                      <li>
                        <Link to="/project/project-details">
                          Social <i className="bi bi-arrow-up-right"></i>
                        </Link>
                      </li>
                    </ul>
                    <ul>
                      <li>
                        <Link to="/project/project-details">
                          Agile Advance <i className="bi bi-arrow-up-right"></i>
                        </Link>
                      </li>
                      <li>
                        <Link to="/project/project-details">
                          Advance <i className="bi bi-arrow-up-right"></i>
                        </Link>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="main-box">
                <div className="box wow fadeInUp">
                  <div className="title-items">
                    <h3>
                      <Link to="/project/project-details">Digital Marketing</Link>
                    </h3>
                  ...
                  <div className="project-content">
                    ...
                    <p>
                      Reprehendeirure irit in volut ate velit esse cillum dolDuis aute irure dolor
                      in ore
                    </p>
                    <Link href="/project/project-details" className="link-btn">
                ...
                <div className="box bg-1 wow fadeInUp" data-wow-delay=".2s">
                  <div className="title-items">
                    <h3>
                      <Link to="/project/project-details">Instantly Analyze</Link>
                    </h3>
                ...
                <div className="box bg-3 wow fadeInUp wow" data-wow-delay=".6s">
                  <div className="title-items">
                    <h3>
                      <Link to="/project/project-details">Email marketing</Link>
                    </h3>
