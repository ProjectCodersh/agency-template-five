                ...
                <div className="single-news-post">
                  ...
                  <div className="post-content">
                    ...
                    <p className="mb-3">
                      ...
                      exercitation ullamco laboris nisi ut aliquip ex ea dolor commodo consequat.
                    ...
                    <div className="hilight-text mt-4">
                      <p>
                        ...
                        ultricies urnacondimentum, sapien neque lobortis tortor, quis efficitur mi
                        ipsum eu metus. Praesent eleifend orci sit amet est vehicula.
                      </p>
                      <svg
                  ...
                  <div className="blog-single-comment d-flex gap-4 pt-4 pb-5">
                    ...
                    <div className="content">
                      <div className="head d-flex flex-wrap gap-2 align-items-center justify-content-between">
                        <div className="con">
                          <h5>
                            <a href="news-details.html">Leslie Alexander</a>
                          </h5>
                  ...
                  <div className="blog-single-comment d-flex gap-4 pt-4 pb-5">
                    ...
                    <div className="content">
                      <div className="head d-flex flex-wrap gap-2 align-items-center justify-content-between">
                        <div className="con">
                          <h5>
                            <a href="news-details.html">Ralph Edwards</a>
                          </h5>
                          <span>February 10, 2024 at 2:37 pm</span>
                        </div>
                        <a href="news-details.html" className="reply">
              ...
              <div className="main-sidebar sticky-style">
                ...
                <div className="single-sidebar-widget">
                  ...
                  <div className="news-widget-categories">
                    <ul>
                      <li>
                        <Link to="/blog/blog-details">Digital Agency</Link> <span>(7)</span>
                      </li>
                      <li>
                        <Link to="/blog/blog-details">Business</Link> <span>(4)</span>
                      </li>
                      <li className="active">
                        <Link to="/blog/blog-details">Digital Product</Link> <span>(5)</span>
                      </li>
                      <li>
                        <Link to="/blog/blog-details">Social Marketing</Link> <span>(3)</span>
                      </li>
                      <li>
                        <Link to="/blog/blog-details">System</Link> <span>(6)</span>
                      </li>
                    </ul>
                  </div>
                </div>
