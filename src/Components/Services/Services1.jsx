  ...
  const chooseContent = [
    {
      ...
      title: 'Search Engine <br/> Optimizations',
      content: 'Collaboratively formulate principle capital doing progressively evolve user',
    },
    {
      img: '/assets/img/service/02.png',
      title: 'One Page SEO <br> Optimization',
      content: 'Collaboratively formulate principle capital doing progressively evolve user',
    },
    {
      img: '/assets/img/service/03.png',
          ...
          {chooseContent.map((item, i) => (
            <div key={i} className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
              <div className="service-card-items">
                <h3 className="title">
                  <Link to="/service/service-details">{parse(item.title)}</Link>
                </h3>
