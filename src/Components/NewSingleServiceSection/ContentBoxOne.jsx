...
const ContentBoxOne = () => {
  const chooseContent = {
    ...
    list4: 'Powerful App Ecosystem',
    list5: 'Mobile-Optimized Shopping Experience',
    list6: 'Scalable for Small to Enterprise Businesses',
    list7: '24/7 Shopify Support',
  };
  ...
  const firstColumnItems = listItems.slice(0, Math.ceil(listItems.length / 2));
  const secondColumnItems = listItems.slice(Math.ceil(listItems.length / 2));
