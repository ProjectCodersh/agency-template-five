export const caseStudiesList = [
  ...
  },
  {
    title: 'Helmsford',
    slug: 'helmsford',
    BgImg: '/assets/img/casestudy/HelmsBriscoe-casestudy.webp',
  },
  { title: 'TireBase', slug: 'tirebase', BgImg: '/assets/img/casestudy/Tirepages-casestudy.webp' },
  {
    title: 'Design Nexus',
    slug: 'design-nexus',
    BgImg: '/assets/img/casestudy/05-Redsign-Hub.webp',
  },
  {
