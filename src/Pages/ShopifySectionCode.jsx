        ...
        <div className="tree-node-wrapper" style={{ color: "#ffffffb3" }}>
            ...
            >
                <div className="tree-icon">
                    {isFolder ? (
                        <i className={`bi ${isOpen ? 'bi-chevron-down' : 'bi-chevron-right'} small-chevron`}></i>
                    ) : (
        ...
        const fetchPageData = async () => {
            try {
                ...
                if (response.data) {
                    ...
                    // Initialize first file if available in the dynamic codeFiles structure
                    if (response.data.codeFiles && response.data.codeFiles.length > 0) {
                        const firstItem = response.data.codeFiles[0];
                        const defaultFile = firstItem.type === 'file' ? firstItem : (firstItem.children?.[0]);
                ...
                <div className="container">
                    <div className="row justify-content-center text-center">
                        <div className="col-lg-9">
                            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="hero-content">
                        ...
                        <div className="col-12">
                            <div className="code-content-main border shadow-sm rounded-4 bg-white overflow-hidden">
                                <div className="tab-navigation-wrapper bg-light px-4 border-bottom d-flex align-items-center overflow-auto no-scrollbar">
                                    <button className={`tab-btn-v2 ${activeTab === 'preview' ? 'active' : ''}`} onClick={() => setActiveTab('preview')}>
                                        <i className="bi bi-eye"></i> Preview
                                    </button>
                                    <button className={`tab-btn-v2 ${activeTab === 'code' ? 'active' : ''}`} onClick={() => setActiveTab('code')}>
                                        <i className="bi bi-code-slash"></i> Code Snippet {!isEmailVerified && <i className="bi bi-lock-fill ms-2 small"></i>}
                                    </button>
                                    <button className={`tab-btn-v2 ${activeTab === 'installation' ? 'active' : ''}`} onClick={() => setActiveTab('installation')}>
                                ...
                                <div className="tab-pane-container p-4 p-lg-5">
                                    <AnimatePresence mode="wait">
                                        {activeTab === 'preview' && (
                                            <motion.div key="preview-tab" initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -15 }} className="tab-panel-v2">
                                                <div className="row g-5 align-items-center">
                                                    <div className="col-lg-8">
                                                        <div className="preview-window shadow-sm rounded-4 border overflow-hidden">
                                                            ...
                                                            <img src={sectionData?.previews?.[0]?.image || '/assets/img/shopify-sections/section-23.png'} alt="Section Preview" className="img-fluid w-100" style={{ minHeight: '400px', objectFit: 'cover' }} />
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-4">
                                                        <div className="p-4 rounded-4 h-100 bg-light-purple border border-primary border-opacity-10">
                                                            ...
                                                            <div className="main-button mt-4">
                                                                <button onClick={() => setActiveTab('code')} className="theme-btn w-100 text-center">Get Section Code</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        {(activeTab === 'code' || activeTab === 'installation') && !isEmailVerified && (
                                            <motion.div key="locked-gate" initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} id="email-gate-area" className="text-center">
                                                <div className="email-card-v2 mx-auto p-4 p-md-5 rounded-4 bg-light border" style={{ boxShadow: '0 15px 40px rgba(0,0,0,0.05)' }}>
                                                    ...
                                                    <form onSubmit={handleEmailSubmit} style={{ maxWidth: "576px", margin: "auto" }}>
                                                        <div className="form-group mb-3">
                                                            <input type="email" className="form-control form-control-lg rounded-pill px-4 py-3" placeholder="yourname@business.com" required value={emailInput} onChange={(e) => setEmailInput(e.target.value)} style={{ fontSize: '15px' }} />
                                                        </div>
                                                        <div className="main-button">
                                                            <button type="submit" className="theme-btn w-100 py-3 justify-content-center">Unlock Section Now</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </motion.div>
                                        ...
                                        {activeTab === 'code' && isEmailVerified && (
                                            <motion.div key="code-view" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}>
                                                <div className="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
                                                    <div>
                                                        <h3 className="h4 fw-bold mb-1">Code Explorer</h3>
                                                        <p className="text-muted small mb-0">Navigate the folder structure and copy individual file snippets.</p>
                                                    </div>
                                                ...
                                                <div className="code-explorer-container rounded-4 border overflow-hidden d-flex">
                                                    ...
                                                    <div className="explorer-sidebar d-none d-md-block" style={{ width: '260px', minHeight: '550px', background: "#161616", borderRight: "2px solid #ffffff1a" }}>
                                                        <div className="p-3 bg-white-5" style={{ borderBottom: "2px solid #ffffff1a" }}>
                                                            <span className="text-uppercase small fw-bold" style={{ color: "#ffffffb3" }}>Files</span>
                                                        </div>
                                                        <div className="file-tree-container py-2" style={{ color: "#ffffffb3" }}>
                                                            {pageData?.codeFiles ? (
                                                    ...
                                                    {/* Main Editor Area */}
                                                    <div className="flex-grow-1 overflow-hidden" style={{ background: "#161616" }}>
                                                        <div className="code-header p-3 bg-white-5 d-flex justify-content-between align-items-center" style={{ borderBottom: '2px solid #ffffff1a' }}>
                                                            <span className=" small font-monospace" style={{ color: "#ffffffb3" }}>
                                                        ...
                                                        <div className="code-editor-content d-flex" style={{ maxHeight: '550px', overflowY: 'auto' }}>
                                                            <div className="line-numbers text-white-50 p-3 text-end" style={{ minWidth: '55px', fontSize: '12px', borderRight: '1px solid#ffffff2a' }}>
                                                                {(selectedFile?.content || "").split('\n').map((_, i) => (
                                                                    <div key={i}>{i + 1}</div>
                                                                ))}
                                                            </div>
                                                            <pre className="p-3 m-0 text-white font-monospace w-100" style={{ fontSize: '13px', lineHeight: '1.7', whiteSpace: 'pre' }}>
                                                                {selectedFile?.content || "// Click a file on the left to view its contents."}
                                                            </pre>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        {activeTab === 'installation' && isEmailVerified && (
                                            <motion.div key="install-view" initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }}>
                                                <div className="row g-5">
                                                    <div className="col-lg-7">
                                                        ...
                                                        <div className="download-card rounded-4 border p-4 p-md-5 bg-light text-center">
                                                            ...
                                                            <p className="text-muted mb-4 mx-auto" style={{ maxWidth: '400px' }}>Download the ready-to-use liquid files and assets for <b>{sectionData?.title}</b>.</p>
                                                            ...
                                                            <div className="main-button justify-content-center">
                                                                <button className="theme-btn px-5 py-3">Download All Files (.ZIP) <i className="bi bi-download ms-2"></i></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div className="installer-timeline">
                                                            <div className="timeline-item d-flex gap-3 mb-4">
                                                                ...
                                                                <div className="timeline-info border-bottom pb-4 w-100">
                                                                    ...
                                                                    <p className="text-muted small mb-0">In Shopify admin, go to <b>Themes &gt; Edit Code</b>. Create a new file in <b>Sections</b> folder.</p>
                                                                </div>
                                                            </div>
                                                            <div className="timeline-item d-flex gap-3 mb-4">
                                                                ...
                                                                <div className="timeline-info border-bottom pb-4 w-100">
                                                                    ...
                                                                    <p className="text-muted small mb-0">Copy the code from the <b>Code Snippet</b> tab and paste it into your new file.</p>
                                                                </div>
                                                            </div>
